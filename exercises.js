...
// 1. Tipos
var original_primitive = 20;
var copy_1 = original_primitive;
copy_1 += 10;
console.log("copy_1", copy_1, "original_primitive", original_primitive);
var original_complex = [10, 20];
var copy_2 = original_complex;
copy_2[0] += 10;
console.log("copy_2", copy_2, "original_complex", original_complex);
var original_complex_obj = { name: "Régis" };
var copy_3 = original_complex_obj;
copy_3.name = "Jully";
